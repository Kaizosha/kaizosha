...
long-page scrolling while a fixed grid strip masks content passing behind it.
The homepage uses a fixed viewport frame containing a real 2×2 product grid,
